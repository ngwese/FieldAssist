...
//!
//! Integrates the workspace crates (composition, session, playback, monitor,
//! UI) into the GPUI editor. Library crate boundaries are described in
//! `docs/ARCHITECTURE.md`.
//!
//! Run with `FieldAssist [FILE]`, or use `--list-devices` / `--dump-init`.
