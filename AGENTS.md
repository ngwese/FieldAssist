...
for the quality gates and where prefetch vs callback work belongs. Prefetch owns provider reads and bandlimited SRC (matched rates copy
bit-exactly); the callback owns monitor DSP so live parameters track
